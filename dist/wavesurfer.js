/*!
 * wavesurfer.js 2.2.1 (2019-06-11)
  ...
  _createClass(WaveSurfer, [{
    ...
    value: function createDrawer() {
      ...
      this.drawer.on('click', function (e, progress) {
        ...
        setTimeout(function () {
          var oldScrollParent = _this5.params.scrollParent;
          _this5.params.scrollParent = false;

          _this5.fireEvent('click', progress * _this5.getDuration());

          _this5.params.scrollParent = oldScrollParent;
        }, 0);
